...
def distance(positions: List[Tuple[float, float, float]]) -> List[float]:
	"""
...
def average_speed(positions: List[Tuple[float, float, float]]) -> List[float]:
	"""
...
def time(positions: List[Tuple[float, float, float]]) -> List[float]:
	"""
...
def best_time(positions_array: List[List[Tuple[float, float, float]]]):
	"""
    ...
    """
	return (min([time(pos) for pos in positions_array]))
...
def best_distance(positions_array: List[List[Tuple[float, float, float]]]):
    ...
    """
	return (min([distance(pos) for pos in positions_array]))
